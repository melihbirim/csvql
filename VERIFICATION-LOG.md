...
| 2026-09-03 | 2045725327 | 50000 | 46302 | 19790 | 3 | 2.6.2 | 1.5.5 | `./bench/query_fuzz.sh --seed 2045725327 --count 50000` | see tests/regressions/ from this run's artifact |
| 2026-09-04 | 72174489 | 50000 | 46417 | 19839 | 5 | 2.6.2 | 1.5.5 | `./bench/query_fuzz.sh --seed 72174489 --count 50000` | see tests/regressions/ from this run's artifact |
| 2026-09-05 | 1338727148 | 50000 | 46267 | 19555 | 5 | 2.6.2 | 1.5.5 | `./bench/query_fuzz.sh --seed 1338727148 --count 50000` | see tests/regressions/ from this run's artifact |
| 2026-09-06 | 759225994 | 50000 | 46289 | 19628 | 3 | 2.6.2 | 1.5.5 | `./bench/query_fuzz.sh --seed 759225994 --count 50000` | see tests/regressions/ from this run's artifact |
| 2026-09-07 | 103085 | 50000 | 46357 | 19854 | 2 | 2.6.2 | 1.5.5 | `./bench/query_fuzz.sh --seed 103085 --count 50000` | see tests/regressions/ from this run's artifact |
| 2026-09-08 | 1001928431 | 50000 | 46397 | 19755 | 2 | 2.6.2 | 1.5.5 | `./bench/query_fuzz.sh --seed 1001928431 --count 50000` | see tests/regressions/ from this run's artifact |
| 2026-09-09 | 1964715881 | 50000 | 46313 | 19571 | 5 | 2.6.3 | 1.5.5 | `./bench/query_fuzz.sh --seed 1964715881 --count 50000` | see tests/regressions/ from this run's artifact |
| 2026-09-10 | 97922906 | 50000 | 46267 | 19524 | 2 | 2.6.3 | 1.5.5 | `./bench/query_fuzz.sh --seed 97922906 --count 50000` | see tests/regressions/ from this run's artifact |
| 2026-09-11 | 2689928610 | 50000 | 46215 | 19689 | 7 | 2.6.3 | 1.5.5 | `./bench/query_fuzz.sh --seed 2689928610 --count 50000` | see tests/regressions/ from this run's artifact |
| 2026-09-12 | 2657615369 | 50000 | 46275 | 19720 | 0 | 2.6.3 | 1.5.5 | `./bench/query_fuzz.sh --seed 2657615369 --count 50000` |  |
| 2026-09-13 | 1323724337 | 50000 | 46327 | 19547 | 0 | 2.6.3 | 1.5.5 | `./bench/query_fuzz.sh --seed 1323724337 --count 50000` |  |
| 2026-09-14 | 2184530613 | 50000 | 46206 | 19632 | 1 | 2.6.3 | 1.5.5 | `./bench/query_fuzz.sh --seed 2184530613 --count 50000` | see tests/regressions/ from this run's artifact |
| 2026-09-15 | 156035442 | 50000 | 46353 | 19829 | 1 | 2.7.0 | 1.5.5 | `./bench/query_fuzz.sh --seed 156035442 --count 50000` | see tests/regressions/ from this run's artifact |
...
| 2026-09-20 | 102543766 | 50000 | 46379 | 19731 | 2 | 2.7.0 | 1.5.5 | `./bench/query_fuzz.sh --seed 102543766 --count 50000` | see tests/regressions/ from this run's artifact |
| 2026-09-21 | 2526323541 | 50000 | 46305 | 19569 | 1 | 2.7.0 | 1.5.5 | `./bench/query_fuzz.sh --seed 2526323541 --count 50000` | see tests/regressions/ from this run's artifact |
| 2026-09-22 | 799823483 | 50000 | 46283 | 19668 | 2 | 2.7.0 | 1.5.5 | `./bench/query_fuzz.sh --seed 799823483 --count 50000` | see tests/regressions/ from this run's artifact |
| 2026-09-23 | 1235312771 | 50000 | 46409 | 19938 | 3 | 2.7.0 | 1.5.5 | `./bench/query_fuzz.sh --seed 1235312771 --count 50000` | see tests/regressions/ from this run's artifact |
| 2026-09-24 | 2392414344 | 50000 | 46250 | 19580 | 0 | 2.7.0 | 1.5.5 | `./bench/query_fuzz.sh --seed 2392414344 --count 50000` |  |
| 2026-09-25 | 1425326468 | 50000 | 46412 | 19786 | 0 | 2.7.0 | 1.5.5 | `./bench/query_fuzz.sh --seed 1425326468 --count 50000` |  |
